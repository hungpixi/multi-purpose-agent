...
class SettingsPanel {
    ...
    static createOrShow(extensionUri, context, mode = 'settings') {
        ...
        const panel = vscode.window.createWebviewPanel(
            ...
            'Antigravity Auto Accept Settings',
                ...
                switch (message.command) {
                    ...
                    case 'saveAndStartQueue':
                        ...
                        if (!scheduleData.prompts || scheduleData.prompts.length === 0) {
                            ...
                            vscode.window.showWarningMessage('Antigravity Auto Accept: Cannot start queue without prompts.');
                            return;
                        }
    ...
    async openLogFile() {
        ...
        try {
            if (!fs.existsSync(filePath)) {
                vscode.window.showInformationMessage('Log file not found yet. Turn Antigravity Auto Accept ON first.');
                return;
            }
    ...
    getHtmlContent() {
        ...
        <body>
            <div class="container">
                <div class="header">
                    <h1>Antigravity Auto Accept <span class="badge">Dashboard</span></h1>
                    <div class="subtitle">Automation controls for Antigravity</div>
                </div>
                ...
                <div class="section">
                    ...
                    <div style="font-size: 13px; opacity: 0.6; margin-bottom: 16px; line-height: 1.5;">
                        Chrome DevTools Protocol port for browser automation. Set 0 to auto-discover the correct port automatically.
                    </div>
                    <div style="display: flex; align-items: center; gap: 12px;">
                        <input type="number" id="cdpPortInput" min="0" max="65535" value="0" 
                ...
                if (saveCdpPortBtn && cdpPortInput) {
                    saveCdpPortBtn.addEventListener('click', () => {
                        ...
                        if (port >= 0 && port <= 65535) {
                            ...
                            cdpPortStatus.textContent = 'Invalid port (0-65535)';
                    ...
                    if (msg.command === 'updateLogs') {
                        ...
                        if (logsMeta) {
                            ...
                            if (meta.exists === false) {
                                logsMeta.innerText = 'Log file not found yet. Turn Antigravity Auto Accept ON to generate logs.';
